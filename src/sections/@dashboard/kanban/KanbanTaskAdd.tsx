...
type KanbanTaskAddPropTypes = {
  onAddTask: () => void;
  onCloseAddTask: () => void;
};

export default function KanbanTaskAdd({ onAddTask, onCloseAddTask }: KanbanTaskAddPropTypes) {
...
export function DisplayTime({ startTime, endTime, isSameDays, isSameMonths, onOpenPicker, sx }: DisplayTimePropTypes) {
  const style = {
    typography: 'caption',
    cursor: 'pointer',
    '&:hover': { opacity: 0.72 },
