...
type KanbanTaskCommentListPropTypes = {
  comments: any[];
};

export default function KanbanTaskCommentList({ comments }: KanbanTaskCommentListPropTypes) {
  ...
  return (
    <>
      <Stack spacing={3} sx={{ py: 3, px: 2.5, bgcolor: 'background.default' }}>
