...
function InputAmount({ autoWidth, amount, onBlur, onChange, sx, ...other }: InputAmountPropTypes) {
  return (
...
type ConfirmTransferDialogPropTypes = {
  amount: number;
  autoWidth: any;
  contactInfo: {
    avatar: string;
...
function ConfirmTransferDialog({
  ...
  onBlur,
  onChange,
}: ConfirmTransferDialogPropTypes) {
  return (
