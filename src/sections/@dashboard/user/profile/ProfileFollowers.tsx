...
type ProfileFollowersPropTypes = {
  followers: any[];
};

export default function ProfileFollowers({ followers }: ProfileFollowersPropTypes) {
  return (
    <Box sx={{ mt: 5 }}>
...
type FollowerCardPropTypes = {
  follower: any;
};

function FollowerCard({ follower }: FollowerCardPropTypes) {
