...
type ProfileGalleryPropTypes = {
  gallery: any[];
};

export default function ProfileGallery({ gallery }: ProfileGalleryPropTypes) {
...
type GalleryItemPropTypes = {
  image: any;
  onOpenLightbox: () => void;
};

function GalleryItem({ image, onOpenLightbox }: GalleryItemPropTypes) {
