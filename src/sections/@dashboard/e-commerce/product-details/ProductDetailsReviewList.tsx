...
type ProductDetailsReviewListPropTypes = {
  product: any;
};

export default function ProductDetailsReviewList({ product }: ProductDetailsReviewListPropTypes) {
...
type ReviewItemPropTypes = {
  review: any;
};

function ReviewItem({ review }: ReviewItemPropTypes) {
