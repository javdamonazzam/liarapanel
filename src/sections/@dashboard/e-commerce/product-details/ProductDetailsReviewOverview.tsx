...
type ProductDetailsReviewOverviewPropTypes = {
  product: any;
  onOpen: () => void;
};

export default function ProductDetailsReviewOverview({ product, onOpen }: ProductDetailsReviewOverviewPropTypes) {
...
type ProgressItemPropTypes = {
  star: any;
  total: number;
};

function ProgressItem({ star, total }: ProgressItemPropTypes) {
