...
type ProductDetailsSummaryPropTypes = {
  cart: any[];
  onAddCart: (target: object) => void;
...
export default function ProductDetailsSummary({
  ...
  onGotoStep,
  ...other
}: ProductDetailsSummaryPropTypes) {
...
function Incrementer({ available, quantity, onIncrementQuantity, onDecrementQuantity }: IncrementerPropTypes) {
  return (
    <Box
      sx={{
        py: 0.5,
