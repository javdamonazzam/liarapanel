...
const ToggleButtonStyle = styled((props: propsType) => <IconButton disableRipple {...props} />)(({ theme }) => ({
  right: 0,
  zIndex: 9,
  width: 32,
  height: 32,
...
export default function ChatRoom({ conversation, participants }: propTypes) {
