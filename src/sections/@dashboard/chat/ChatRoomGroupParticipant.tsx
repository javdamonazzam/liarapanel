...
type propTypes = {
  participants: any[];
  selectUserId?: string;
  onShowPopupUserInfo?: (id: number) => void;
  isCollapse?: boolean;
  onCollapse?: () => void;
};
...
type PaticipantPropTypes = {
  participant: { name; avatar; status; position };
  isOpen?: boolean;
  onClosePopup?: () => void;
  onShowPopup?: () => void;
};

function Participant({ participant, isOpen, onClosePopup, onShowPopup }: PaticipantPropTypes) {
