...
// utils
import { fDateTime } from '@utils/formatTime.tsx';
import { getFileFullName, getFileThumb } from '@utils/getFileFormat.tsx';
// components
...
export default function ChatRoomAttachment({ conversation, isCollapse, onCollapse }: propTypes) {
...
type AttachmentItemPropTypes = {
  file: any;
  fileUrl: string;
};

function AttachmentItem({ file, fileUrl }: AttachmentItemPropTypes) {
  return (
