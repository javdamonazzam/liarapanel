...
type propTypes = {
  values?: { title; content; description; cover };
  isValid?: boolean;
...
export default function BlogNewPostPreview({ values, isValid, isSubmitting, isOpen, onClose, onSubmit }: propTypes) {
...
type PreviewHeroPropTypes = {
  cover?: string;
  title?: string;
};

function PreviewHero({ title, cover }: PreviewHeroPropTypes) {
  return (
