...
import { fShortenNumber } from '@utils/formatNumber.tsx';
// components
...
export default function BlogPostCard({ post, index }: propTypes) {
...
export function PostContent({ title, view, comment, share, createdAt, index }: PostContentPropTypes) {
  const isDesktop = useResponsive('up', 'md');
