...
// @mui
import { Typography, ListItemText, ListItemButton, Link } from '@mui/material';
// @types
...
export default function MailSidebarItem({ label, ...other }: propTypes) {
