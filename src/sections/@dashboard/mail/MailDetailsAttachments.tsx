...
type MailDetailsAttachmentsPropTypes = {
  mail: any;
};

export default function MailDetailsAttachments({ mail }: MailDetailsAttachmentsPropTypes) {
  return (
    <RootStyle>
      <Scrollbar>
        <Box sx={{ display: 'flex' }}>
...
function FileItem({ fileUrl }: FileItemPropTypes) {
  return (
