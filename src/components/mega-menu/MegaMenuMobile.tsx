...
type MegaMenuMobilePropTypes = {
  navConfig: any[];
};

export default function MegaMenuMobile({ navConfig }: MegaMenuMobilePropTypes) {
...
function ParentItem({ icon, title, hasSub, ...other }: ParentItemPropTypes) {
  return (
...
function SubMenu({ parent, pathname }: SubMenuPropTypes) {
