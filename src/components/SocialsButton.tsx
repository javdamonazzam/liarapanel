...
type propTypes = {
  ...
  links?: { facebook?: string; instagram?: string; linkedin?: string; twitter?: string };
  simple?: boolean;
  sx?: SxProps;
} & ButtonProps;

export default function SocialsButton({ initialColor = false, simple = true, links = {}, sx, ...other }: propTypes) {
  const SOCIALS = [
    {
      name: 'FaceBook',
