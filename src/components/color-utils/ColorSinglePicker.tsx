// @mui
import { Box, Radio, RadioGroup, SxProps } from '@mui/material';
// components
import Iconify from '../Iconify';

// ----------------------------------------------------------------------

type ColorSinglePickerPropTypes = {
  colors: string[];
};

export default function ColorSinglePicker({ colors, ...other }: ColorSinglePickerPropTypes) {
  return (
