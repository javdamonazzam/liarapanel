...
type VerticalBoxPropTypes = {
  isSelected: boolean;
};

function VerticalBox({ isSelected }: VerticalBoxPropTypes) {
  return (
    <>
      <Box
        sx={{
...
type HorizontalBoxPropTypes = {
  isSelected: boolean;
};

function HorizontalBox({ isSelected }: HorizontalBoxPropTypes) {
  return (
    <>
      <Box
        sx={{
