...
export default function MenuMobile({ isOffset, isHome, navConfig }: propTypes) {
...
function MenuMobileItem({ item, isOpen, onOpen }: MenuMobileItemPropTypes) {
  const { pathname } = useRouter();
